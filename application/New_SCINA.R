#################################################### create new scina function that can be used by docker #########################################################################################
...
check.inputs=function(exp, signatures, max_iter, convergence_n, convergence_rate, sensitivity_cutoff, rm_overlap)
{
...
SCINA_New=function(exp,signatures,max_iter=100,convergence_n=10,convergence_rate=0.99,
  ...
  quality=check.inputs(exp,signatures,max_iter,convergence_n,convergence_rate,sensitivity_cutoff,rm_overlap)
  if(quality$qual==0){
